...
void loop() {
  ...
  greennorm /= normalize;
  bluenorm /= normalize;
  Serial.println("Here"); //CODY
  Serial.println(gammatable[(int)r]); //CODY
  Serial.println(gammatable[(int)g]); //CODY
  Serial.println(gammatable[(int)b]); //CODY
